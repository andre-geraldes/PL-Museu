...
\begin{abstract}
Este trabalho foi realizado no âmbito da Unidade Curricular de Processamento de Linguagens e visa, através da construção de um filtro de texto, melhorar a capacidade de desenvolvimento de \emph{Expressões Regulares} bem como aumentar a experiência de utilização da linguagem C.\\
...
\begin{lstlisting}[caption={Exemplo de uma Listagem}, label={lstExe1}]
      ou então aparecer aqui neste sítio
